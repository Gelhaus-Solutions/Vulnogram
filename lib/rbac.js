...
const CAPABILITIES = {
    ...
    CVE_READ: 'cve.read',
    CVE_TRANSITION: 'cve.transition',
    CVE_REVIEW: 'cve.review',
    CVE_APPROVE: 'cve.approve'
};
...
const DEFAULT_ROLES = [
    ...
    { name: 'TeamAdmin', scope: 'team', builtin: true, capabilities: ['team.manage', 'cve.create', 'cve.edit', 'cve.delete', 'cve.publish', 'cve.read', 'cve.transition', 'cve.review', 'cve.approve'] },
    { name: 'Editor', scope: 'team', builtin: true, capabilities: ['cve.create', 'cve.edit', 'cve.publish', 'cve.read', 'cve.transition'] },
